...
WHALE_FLEET = [
    ...
    {'name': 'AURORA I',         'operator': 'Wild Whales Vancouver',  'icon_color': '#1f77b4', 'mmsi': 316040487},
    {'name': 'AURORA II',        'operator': 'Wild Whales Vancouver',  'icon_color': '#1f77b4', 'mmsi': 316040366},
    {'name': 'EAGLE EYES',       'operator': 'Wild Whales Vancouver',  'icon_color': '#1f77b4', 'mmsi': 316034894},
    {'name': 'JING YU',          'operator': 'Wild Whales Vancouver',  'icon_color': '#1f77b4', 'mmsi': 316032442},
    # Vancouver Whale Watch
    {'name': 'EXPLORATHOR II',      'operator': 'Vancouver Whale Watch',  'icon_color': '#2ca02c', 'mmsi': 316008046},
    ...
    {'name': 'STRIDER',          'operator': 'Vancouver Whale Watch',  'icon_color': '#2ca02c', 'mmsi': 316035167},
    {'name': 'LIGHTSHIP',        'operator': 'Vancouver Whale Watch',  'icon_color': '#2ca02c', 'mmsi': 316014609},
    # Prince of Whales (Vancouver, Victoria, Telegraph Cove)
    {'name': 'SALISH SEA DREAM',   'operator': 'Prince of Whales', 'icon_color': '#ff7f0e', 'mmsi': 316032858},
    {'name': 'SALISH SEA FREEDOM', 'operator': 'Prince of Whales', 'icon_color': '#ff7f0e', 'mmsi': 316042213},
    {'name': 'SALISH SEA ECLIPSE', 'operator': 'Prince of Whales', 'icon_color': '#ff7f0e', 'mmsi': 316039686},
    {'name': 'SALISH SEA GLORY',   'operator': 'Prince of Whales', 'icon_color': '#ff7f0e', 'mmsi': 316059231},
    {'name': 'OCEAN MAGIC II',     'operator': 'Prince of Whales', 'icon_color': '#ff7f0e', 'mmsi': 316008331},
    {'name': 'OCEAN MAGIC',        'operator': 'Prince of Whales', 'icon_color': '#ff7f0e', 'mmsi': 316006789},
