...
def headerbox():
    ...
    display_beach_quality_for_sandy_cove(container=tab10, title="🏖️ Beach water quality Sandy Cove")
    ...
    display_beach_quality_for_sandy_cove(container=tab9, title="🏖️ Beach water quality Sandy Cove")
